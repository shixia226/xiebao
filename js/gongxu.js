        ...
        EUI.getCmp("button", {
            ...
            onclick: function(btn, gongxuList, xinghaoList) {
                ...
                if (len) {
                    ...
                    EUI.ajax({
                        url: "/xinghao?cmd=update-xh&xh=" + xinghao + "&gxs=" + encodeURIComponent(JSON.stringify(datas)),
                        context: xinghaoList,
                        onfinish: function() {
            ...
            btn.getContainer().style.cssText += '; position: absolute; margin-top: 10px;';
        });
    });
});